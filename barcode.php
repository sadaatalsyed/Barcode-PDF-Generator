...
if(isset($_POST['OK'])){
   ...
   if( $data=mysqli_fetch_assoc($result)){
    ...
    $task_name=$data['task_name'];
         ...
         $query="select *  from parts ORDER BY id";
       ...
       ?>
        ...
        <br>
        <p style=" color:red; margin-top:5px; margin-left:20px; text-align:center; ">Please insert any of the following identcodes</p>
        <table border="-3" style=" margin-top:10px; width:50%;  margin-left:50vh; justify-content:center; text-align:center; ">
        <th>IdentCode</th>
        <th>Item Name</th>
        <?php
        ...
        <button style="background:Yellow; margin-left: 100vh;margin-top: 5vh;text-align:center"><a href="index.php">Back</a></button>
	  <?php
